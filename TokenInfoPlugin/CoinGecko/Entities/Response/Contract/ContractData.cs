...
namespace CoinGecko.Entities.Response.Contract
{
    public class ContractData
    {
        ...
        [JsonPropertyName("market_cap_rank")] public long? MarketCapRank { get; set; }

        [JsonPropertyName("coingecko_rank")] public long? CoinGeckoRank { get; set; }

        [JsonPropertyName("coingecko_score")] public double? CoinGeckoScore { get; set; }

        [JsonPropertyName("developer_score")] public double? DeveloperScore { get; set; }

        [JsonPropertyName("community_score")] public double? CommunityScore { get; set; }

        [JsonPropertyName("liquidity_score")] public double? LiquidityScore { get; set; }

        [JsonPropertyName("public_interest_score")] public double? PublicInterestScore { get; set; }
