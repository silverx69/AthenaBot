...
namespace CoinGecko.Clients
{
    public partial class CoinGeckoClient : IDisposable, ICoinGeckoClient
    {
        ...
        public CoinGeckoClient(JsonSerializerOptions serializerSettings) : this(new HttpClientHandler(), serializerSettings)
        {
        }

        public CoinGeckoClient(JsonSerializerOptions serializerSettings, string apiKey) : this(new HttpClientHandler(), serializerSettings, apiKey)
        {
        }


        public CoinGeckoClient(HttpClientHandler httpClientHandler, JsonSerializerOptions serializerSettings) : this(new HttpClient(httpClientHandler, true), serializerSettings)
        {
        }

        public CoinGeckoClient(HttpClientHandler httpClientHandler, JsonSerializerOptions serializerSettings, string apiKey)
        ...
        public CoinGeckoClient(HttpClient httpClient, JsonSerializerOptions serializerSettings)
        {
            _httpClient = httpClient;
            _serializerSettings = serializerSettings;
        }

        public CoinGeckoClient(HttpClient httpClient, JsonSerializerOptions serializerSettings, string apiKey)
        {
            _httpClient = httpClient;
            _serializerSettings = serializerSettings;
            _apiKey = apiKey;
