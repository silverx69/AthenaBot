...
namespace CoinGecko.Clients
{
    public class BaseApiClient : IAsyncApiRepository
    {
        ...
        public BaseApiClient(HttpClient httpClient, JsonSerializerOptions serializerSettings, string apiKey) {
            _httpClient = httpClient;
            _serializerSettings = serializerSettings;
            _apiKey = apiKey;
        }

        public BaseApiClient(HttpClient httpClient, JsonSerializerOptions serializerSettings) {
            _httpClient = httpClient;
            _serializerSettings = serializerSettings;
        }
        ...
        public async Task<T> GetAsync<T>(Uri resourceUri) {
            ...
            try {
                return JsonSerializer.Deserialize<T>(responseContent, _serializerSettings);
            }
            catch (Exception e) {
